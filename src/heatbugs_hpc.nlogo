...
to go
  ...
  ;; my code: Gets statistics, store the results in global variables.
  set sim-step ticks
  set unhappiness-average mean [unhappiness] of turtles
...
399
unhappiness_average
mean [unhappiness] of turtles
6
1
11

@#$#@#$#@
## CHANGES BY LUIS RAMALHO

Adapted to run from command line scripts with reproducible random seeds.
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>finnish</exitCondition>
    <metric>ticks</metric>
    <metric>mean [unhappiness] of turtles</metric>
    <enumeratedValueSet variable="bug-count">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="random-move-chance">
      <value value="0"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="min-ideal-temp">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max-ideal-temp">
      <value value="40"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="min-output-heat">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max-output-heat">
      <value value="25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="numiterations">
      <value value="200"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="rngseed">
      <value value="236542"/>
    </enumeratedValueSet>
